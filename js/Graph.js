...
var SVGFrame = function (d3svgContainer, margin, widthContainer, heightContainer) {
...
*
*/
var Graph = function (svgSelector, numberPoint) {
  this.__margin = 6;
  this.__timeRange = 30;
  ...
  this.svgFrame = new SVGFrame(this.d3svgContainer, this.__margin, this.widthContainer, this.heightContainer);
  ...
  var axisYScale = this.svgFrame.getAxisYScale();
